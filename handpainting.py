...
paintWindow = cv2.rectangle(paintWindow, (10, 10), (60, 60), colors["WHITE"], 2)
...
paintWindow = cv2.rectangle(paintWindow, (430, 10), (480, 60), colors["RED"], -1)
cv2.putText(paintWindow, "CLEAR", (20, 38), cv2.FONT_HERSHEY_SIMPLEX, 0.3, colors["WHITE"], 1, cv2.LINE_AA)
...
cv2.putText(paintWindow, "RED", (446, 38), cv2.FONT_HERSHEY_SIMPLEX, 0.3, colors["WHITE"], 1, cv2.LINE_AA)
...
while True:
    ...
    res.handtrack(frame)
    frame = cv2.rectangle(frame, (10, 10), (60, 60), colors["WHITE"], 2)
    ...
    frame = cv2.rectangle(frame, (430, 10), (480, 60), colors["RED"], -1)
    cv2.putText(frame, "CLEAR", (20, 38), cv2.FONT_HERSHEY_SIMPLEX, 0.3, colors["WHITE"], 1, cv2.LINE_AA)
    ...
    cv2.putText(frame, "RED", (446, 38), cv2.FONT_HERSHEY_SIMPLEX, 0.3, colors["WHITE"], 1, cv2.LINE_AA)
    ...
    cv2.putText(frame, str(x) + " " + str(y), (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 1, (176, 255, 156), 1)
